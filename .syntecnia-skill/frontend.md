# Frontend with Syntecnia

Syntecnia serves HTML from the server (SSR). There is **no imposed framework or CSS** —
...
Serve your own JavaScript from `static/` and reference it in your templates. Syntecnia
