...
// `fnmatch` y `normalize_path` viven en `synsema_core::capscope` (los usa también
// `synsema check`, que no puede depender de este crate): un solo matcher de scopes.
pub use synsema_core::capscope::{fnmatch, normalize_path};
