# Syntecnia Language Skill

You are working with Syntecnia, a programming language designed for AI agents. This document is your complete reference for understanding, writing, and debugging Syntecnia programs.
...
│   ├── engine.py          # SyntecniaEngine — ties everything together
...
When errors occur, Syntecnia provides:
- File, line, column
...
```bash
syntecnia run file.syn                    # Standard run
syntecnia run file.syn --provider claude  # With LLM
syntecnia run file.syn --secure           # All caps must be granted
syntecnia run file.syn --grant net:*.api.com  # Grant capability
syntecnia run file.fsyn                   # Flat syntax
syntecnia repl                            # Interactive
syntecnia testgen file.syn                # Auto-generate tests
```
