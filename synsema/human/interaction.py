"""
Synsema Human Interaction System.

Human interaction is a first-class concept in Synsema. Unlike traditional
programs where human interaction is an afterthought (print/input), Synsema
...
class InteractionManager:
    """
    Manages all human interaction for a Synsema program.
