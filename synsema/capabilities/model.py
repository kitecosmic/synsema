"""
Synsema Capability Model.

Capabilities are the security foundation of Synsema. Instead of giving
a program full access and restricting afterward (like traditional OS permissions),
Synsema gives ZERO access by default and requires explicit capability grants.
