"""
Synsema Token Definitions.

Tokens are the atomic units of the language. Synsema's tokens reflect
...
class Token:
    """
    A single token from the Synsema source.
