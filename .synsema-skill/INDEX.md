...
| **Diagnose `judge` config** (v0.6.26+) | `synsema judge status [--json]` (provider, key presence, model, budget, whether `decide` is served by the judge; exit 1 offline) → see [judge.md](judge.md) |
