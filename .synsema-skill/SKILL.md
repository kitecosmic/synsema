...
**By topic**
- [stdlib.md](stdlib.md) — HTTP requests, databases (SQL: SQLite / Postgres / MySQL · document: MongoDB · key-value: Redis), cron scheduler, blockchain signing (ETH/EVM · Avalanche · Solana · Algorand: gated `sign` + audit, keccak256, RLP, base58/base32/bech32, EIP-55)
