...
- [processes.md](processes.md) — OS processes: one-shot `run` and live `proc_*` (streamed output, stdin, kill, `pty: true` for prompts/TUIs/web terminals), both gated by `exec`
