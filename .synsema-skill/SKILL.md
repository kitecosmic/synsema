...
| **Bundle into ONE binary** (v0.6.14+) | `synsema build app.syn -o app --include static/` — engine + program + assets, sha256-sealed; runs the program (`args()` is its argv); `app --engine <cmd>` reaches the engine → [deploy.md](deploy.md) |
