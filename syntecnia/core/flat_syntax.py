"""
Syntecnia Flat Syntax — Document-style alternative syntax.
...
This module translates flat syntax to standard Syntecnia source,
...
class FlatSyntaxTranslator:
    """
    Translates flat/document-style syntax into standard Syntecnia.

    This is a pre-processor: flat syntax → standard syntax → lexer → parser.
    """

    def translate(self, source: str) -> str:
        """Translate flat syntax to standard Syntecnia."""
        lines = source.split("\n")
        output_lines = []
        i = 0
    ...
    def _translate_statement(self, line: str) -> str:
        """Translate a single flat-syntax statement to standard Syntecnia."""
...
def translate_flat(source: str) -> str:
    """Convenience function: translate flat syntax to standard Syntecnia."""
