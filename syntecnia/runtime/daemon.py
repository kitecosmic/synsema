"""
Syntecnia Daemon — Run agents as system services.

    syntecnia daemon start program.syn     Start as background daemon
    syntecnia daemon stop program.syn      Stop a running daemon
    syntecnia daemon status                Show all running daemons
    syntecnia daemon logs program.syn      Tail the daemon logs
    syntecnia daemon restart program.syn   Restart a daemon
...
Files:
    ~/.syntecnia/daemons/<name>/pid      Process ID
    ~/.syntecnia/daemons/<name>/log      stdout + stderr
    ~/.syntecnia/daemons/<name>/meta     program path, start time, etc.
...
def daemon_start(program_path: str, extra_args: List[str] = None,
    ...
    """
    Start a Syntecnia program as a background daemon.
    ...
    cmd = [python, "-m", "syntecnia", "run", program_path, "--serve"]
    if extra_args:
