//! Definiciones de tokens de Synsema.
//!
//! Port fiel de `synsema/core/tokens.py`. Los tokens son las unidades atómicas
...
/// Un token del fuente Synsema. Cada token lleva su ubicación para trazabilidad.
#[derive(Clone, Debug, PartialEq)]
pub struct Token {
    pub ty: TokenType,
